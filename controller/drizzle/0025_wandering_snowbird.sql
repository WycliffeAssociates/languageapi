...
m.show_on_biel, m.status AS meta_status, l.national_name as language_name, l.english_name as language_english_name, l.ietf_code, g.repo_url
...
GROUP BY c.id, CONCAT(g.repo_url, '/archive/master.zip'), m.id, l.national_name, l.english_name, l.ietf_code, g.repo_url
